 ...
 * @internal
 */
export type McpServerLoader = (config: string | Record<string, McpServerConfig>, defaults?: McpClientOptions) => Promise<McpClientConfig[]>;
/**
 ...
 * @internal
 */
export declare const mcpServerLoader: import("../default-slot.js").DefaultSlot<McpServerLoader>;
