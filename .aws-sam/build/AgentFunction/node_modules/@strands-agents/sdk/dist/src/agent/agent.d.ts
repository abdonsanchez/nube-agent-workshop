import { AgentResult, type AgentStreamEvent, type InvokableAgent, type InvokeArgs, type InvokeOptions, type LocalAgent, type localAgentSymbol } from '../types/agent.js';
import { Message, type MessageData, type SystemPrompt, type SystemPromptData } from '../types/messages.js';
 ...
 */
export declare class Agent implements LocalAgent, InvokableAgent {
    /** @internal */
    ...
    private readonly _interventionRegistry;
     ...
     * ```
     */
    addHook<T extends HookableEvent>(eventType: HookableEventConstructor<T>, callback: HookCallback<T>, options?: HookCallbackOptions): HookCleanup;
    /**
     ...
     * ```
     */
    addMiddleware<TContext, TResult, TEvent>(phase: MiddlewareInputPhase<TContext, TResult, TEvent>, handler: MiddlewareInputHandler<TContext>): () => void;
    /**
     * Register a Wrap phase handler via the explicit `.Wrap` sub-token.
     * Equivalent to passing the stage token directly.
     */
    addMiddleware<TContext, TResult, TEvent>(phase: MiddlewareWrapPhase<TContext, TResult, TEvent>, handler: MiddlewareHandler<TContext, TResult, TEvent>): () => void;
    /**
     ...
     * ```
     */
    addMiddleware<TContext, TResult, TEvent>(phase: MiddlewareOutputPhase<TContext, TResult, TEvent>, handler: MiddlewareOutputHandler<TResult>): () => void;
    /**
     ...
     * ```
     */
    addMiddleware<TContext, TResult, TEvent>(stage: MiddlewareStage<TContext, TResult, TEvent>, handler: MiddlewareHandler<TContext, TResult, TEvent>): () => void;
     ...
     */
    private _extractStructuredOutput;
    /**
     ...
     */
    private _createInterruptResult;
    /**
     ...
     */
    private _extractInterruptResponses;
    /**
     ...
     */
    private _extractCheckpointResume;
    /**
     ...
     */
    private _invokeModelWithMiddleware;
    /**
     ...
     */
    private _appendMessageAndFireHooks;
    /**
