 ...
 * @internal
 */
export declare function resolveMantleRegion(config: BedrockMantleConfig): string;
/**
 ...
 * @internal
 */
export declare function bedrockMantleBaseUrl(region: string, modelId: string): string;
/**
 ...
 * @internal
 */
export declare function createMantleApiKeySetter(config: BedrockMantleConfig, region: string): () => Promise<string>;
