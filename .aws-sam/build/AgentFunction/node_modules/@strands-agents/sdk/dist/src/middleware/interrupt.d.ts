 ...
 * @internal
 */
export declare function createMiddlewareInterrupt(interruptState: InterruptState, idPrefix: string): <T = JSONValue>(params: InterruptParams) => MiddlewareInterruptResult<T>;
