...
export class Swarm {
    ...
    _resolveContent(state) {
        ...
        const handoff = last.structuredOutput;
        if (handoff?.message) {
     ...
     */
    _findResumeNode(state) {
        const lastResult = state.results[state.results.length - 1];
        if (!lastResult)
            return undefined;
        const lastNodeHandoff = lastResult.structuredOutput;
        if (!lastNodeHandoff?.agentId)
            return undefined;
