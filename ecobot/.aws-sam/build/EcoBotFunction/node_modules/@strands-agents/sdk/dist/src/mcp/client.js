...
export class McpClient {
    ...
    async callTool(tool, args, options) {
        ...
        if (this._tasksConfig === undefined) {
            return (await this._client.callTool({ name: tool.name, arguments: toolArgs }, undefined, options));
        }
