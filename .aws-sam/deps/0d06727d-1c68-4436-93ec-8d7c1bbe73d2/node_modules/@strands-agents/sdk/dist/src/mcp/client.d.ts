 ...
 */
export type McpTransport = Omit<Transport, 'sessionId'> & {
...
export declare class McpClient {
     ...
     */
    static loadServers(config: string | Record<string, McpServerConfig>, defaults?: McpClientOptions): Promise<McpClient[]>;
    private _clientName;
    ...
    private _registeredToolNames;
    private _onToolsChanged;
    private _refreshingTools;
     ...
     */
    callTool(tool: McpTool, args: JSONValue, options?: McpCallToolOptions): Promise<JSONValue>;
}
