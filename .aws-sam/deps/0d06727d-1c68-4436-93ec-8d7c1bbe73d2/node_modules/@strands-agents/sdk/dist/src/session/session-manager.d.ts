 ...
 * ```
 */
export declare class SessionManager implements Plugin, MultiAgentPlugin {
    private readonly _sessionId;
    private readonly _storage;
    private readonly _saveLatestOn;
    private readonly _snapshotTrigger?;
    private readonly _multiAgentSaveLatestOn;
    private _multiAgentRestoredIds;
    /**
     * Unique identifier for this plugin.
     */
    get name(): string;
    constructor(config: SessionManagerConfig);
    private get _snapshotStorage();
