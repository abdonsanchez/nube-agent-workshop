 ...
 */
export declare function defaultModelWarningMessage(defaultModelId: string): string;
/**
 ...
 * @returns Formatted warning message string
 */
export declare function defaultMaxTokensWarningMessage(defaultMaxTokens: number): string;
/**
 ...
 */
export declare function getContextWindowLimit(modelId: string): number | undefined;
